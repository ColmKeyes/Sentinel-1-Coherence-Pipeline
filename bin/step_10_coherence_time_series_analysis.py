...
if __name__ == '__main__':
    ...
    shp = gpd.read_file('D:\Data\\geometries\\updated_initial_to_new_5points.shp')  #'ordered_gcp_6_items_Point.shp')
    ...
    # Set plot titles, based on shp file - old and newer used versions
    OLDtitles = ['Historically Disturbed Forest Area', 'Recent Encroachment Forest Area', 'Water and Sparse Vegetation Area', 'Farmland', 'Large Disturbance Forest Area', 'Intact Forest']
    titles= ['Intact Forest','Historically Disturbed Forest Area','Water and Sparse Vegetation Area', 'Recent Encroachment Forest Area','Farmland', 'Large Disturbance Forest Area']

    ##############
    ## plot time series event detections
    ##############
    kalimantan.stats(titles)

    ##############
    ## plot change mapping for selected region.
    ##############
    ...
    #kalimantan.single_plot(titles,plot_code=5)
    ...
    # kalimantan.precip_perpdist_plot(perp_dist_diff,OLDtitles)
    # kalimantan.precip_perpdist_plot(perp_dist_diff,OLDtitles)

    ##############
    # Uncomment the following for the distribution of disturbance events deteced by the RADD alert system
    ##############
    print("Depreciated method.")
